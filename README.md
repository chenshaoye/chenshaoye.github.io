...
>
### [查看博客戳这里 👆](https://chenshaoye.github.io)
...
```
# Site settings
title: shaoye Blog                    # 你的博客网站标题
SEOTitle: 小少爷的博客 | shaoye Blog		# SEO 标题
description: "Hey"	   	   # 随便说点，描述一下

# SNS settings      
github_username: chenshaoye     # 你的github账号
...
看右边:
![](https://raw.githubusercontent.com/chenshaoye/chenshaoye.github.io/master/img/readme-side.png)
...
sidebar-avatar: /img/avatar-shaoye.jpg     #你的大头贴，请使用绝对地址.注意：名字区分大小写！后缀名也是
```
...
friends: [
    {
        title: "shaoye Blog",
        href: "https://chenshaoye.github.io/"
    },
    {
        title: "Apple",
...
参考我的这篇文章：[《为博客添加 Gitalk 评论插件》](http://chenshaoye.top/2017/12/19/%E4%B8%BA%E5%8D%9A%E5%AE%A2%E6%B7%BB%E5%8A%A0-Gitalk-%E8%AF%84%E8%AE%BA%E6%8F%92%E4%BB%B6/)
...
我的博客标题是 **“shaoye Blog”** 但是我想要在搜索的时候显示 **“小少爷的博客 | shaoye Blog”** ，这个就需要 SEO Title 来定义了。
...
遵循 MIT 许可证。有关详细,请参阅 [LICENSE](https://github.com/chenshaoye/chenshaoye.github.io/blob/master/LICENSE)。
